...
''')
    ...
    def test_cost_calculation_performance_large(self, large_terraform_config):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.tf', delete=False) as f:
            ...
            try:
                ...
                print(f"✅ Calculated costs for {summary['total_resources']} resources in {calc_time:.3f}s")
    ...
    def test_concurrent_calculations(self, medium_terraform_config):
        ...
        assert concurrent_time < 2.0, f"Concurrent calculations took too long: {concurrent_time:.2f}s"
